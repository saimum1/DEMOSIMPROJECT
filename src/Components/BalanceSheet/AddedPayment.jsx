...
const AddedPayment = ({isOpen, onClose ,action,getdata, agentId,data,optiontype}) => {
    ...
    const SaveOperator = async () => {
        try {
            ...
            const response = await axios.post(`${config.apiUrl}/api/financial/sim/agents/${agentId}/payment`, convertedData,{
                headers: {
    ...
    const handleUpdate = async () => {
        try {
            ...
            const response = await axios.put(`${config.apiUrl}/api/financial/sim/agents/${agentId}/payment/${datalist?.paymentid}`, convertedData,{
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
            ...
            >
                ...
                <ModalContent bg={global_css.modal_bg} style={{color : 'white'}}>
                    ...
                    {datalist?.paymentType !== 'cash' &&                                         
                        ...
                        <FormControl className='mt-5'>
                            <FormLabel style={{fontWeight :'bold',fontSize:'12px'}}>{t('transactions')} {t('details')}</FormLabel>
                            <Textarea  style={{
                                outline: 'none !important',
                                boxShadow: 'none',
                                border : '1px solid #595959',
